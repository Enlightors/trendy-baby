    ...
    >
      <div className="container mx-auto max-w-xl bg-[#00B1D5] px-6 py-2 rounded-lg shadow-lg">
        ...
        <div className="space-y-2 text-gray-100 mb-8">
          <p>
            Our number 1 goal is your satisfaction. Our customer service team is
            available to help you through the following channels:{" "}
            <a href="#" className="text-blue-200 underline hover:text-blue-400">
              Help Center
            </a>
